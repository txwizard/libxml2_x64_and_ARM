 ...
 *	Name:				runsuite.c: 
 *
 *  Goal:				C program to run libxml2 againts published testsuites
 *
 ...
 *  Date       By Remark
 *  ---------- -- --------------------------------------------------------------
 *	2019/03/30 DG Incorporate a logo, followed immediately by a message to
 *                identify the hardware platform on which it is executing.
 *	============================================================================
 */
...
#include <stdio.h>
	...
	#include <CRTTime.H>				// Declare CRTTime functions under test.
...
#else /* #if defined ( LIBXML_SCHEMAS_ENABLED ) && defined ( LIBXML_XPATH_ENABLED ) */
int
...
#endif	/* #if defined ( LIBXML_SCHEMAS_ENABLED ) && defined ( LIBXML_XPATH_ENABLED ) */